...
<!--
**Seoyeong-Gu/Seoyeong-Gu** is a ✨ _special_ ✨ repository because its `README.md` (this file) appears on your GitHub profile.
...
- 정보관리연구소: 용어관계사전 DB 구축 사업

**2024**
- 도서관 데이터 활용 공모전: 도서관 검색 시스템의 패러다임 전환을 위한 대화형 AI '북나래봇' 개발
- 정보관리연구소: 용어관계사전 DB 구축 사업

**2023**
- 성균관대학교 Co-Deep Learning: 정보검색 기반 데이터 분석을 활용한 식품 알레르기 예방 프로젝트 (데이터베이스 및 시소러스 구축 담당)

**2022**
- 성균관대학교 Learning Fair: 시각장애 학우를 위한 학교 기사 요약 TTS 서비스 'SKKU News'
